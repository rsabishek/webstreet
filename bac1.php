...
function al()
{ alert("Your downlaod key is wrong, Please try again!");
}
...
<input type="text" name="nam" id="name" value="player1"/>

<label>_lucky Token</label>
<select id="p1t" name="tokenn">
...
<input type="submit"  class="button"  value="player2">
</form>
</div>
...
<input type="button"  class="button" onclick="save()" value="run in web street">
