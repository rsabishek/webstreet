...
$_SESSION['cb1']="player1";
$_SESSION['cb2']="player2";
$_SESSION['to1']="1";
$_SESSION['to2']="2";
...
//call proceure to chec	
echo 'alert("blog purchase done!")';	

//$_SESSION['sp1']=$_SESSION['sp1']-val;


//$_SESSION['sp2']=$_SESSION['sp2']-val;

//call proc. transaction_rent
}
?>
...
//call proc. to check whether the blog purchased or not...
...
bu.style.display="none";//buy
//au.style.display="none";//auction
document.getElementById("c3_b").style.display="none";
document.getElementById("bar1").innerHTML="cb1";
document.getElementById("bar2").innerHTML="cb2";
}

var centr=0;	
function hat()
{
var q1=document.getElementById("bar1").value;	
var q2=document.getElementById("bar2").value;
document.getElementById("a1").innerHTML=q1;
document.getElementById("a2").innerHTML=q2;

if(q1<centr) {document.getElementById("writ").innerHTML="player 2 wins auction!";
alert('auction over.now back to business.');

//call transaction_rent proc.

buyng();}
if(q2<centr) {document.getElementById("writ").innerHTML="player 1 wins auction!";
alert('auction over.now back to business.');

//call transaction_rent proc.
buyng();}

if(q1>q2) centr=q1; else centr=q2;
}

function market()
{
if(set==1)		
document.getElementById("asq").innerHTML=to_move;		

if(set==0)		
document.getElementById("asq").innerHTML=to_mov2;		
...
<div id="c3" style="display:block;position:absolute;color:#FFF">
Auction Desk
<div  id="race" style="display:block;position:absolute">
<input type="range" id="bar1"  style="color:#FFF;display:block;position:absolute;left:10px;top:40px" value="0" onClick="hat()" min="0"></input>

<input type="range" id="bar2"  style="color:#FFF;display:block; position:absolute;left:200px;top:40px" value="0" onClick="hat()" min=""></input>
<div id="m1" style="position:absolute;color:#FFF;top:30px;left:15px"><?php echo $_SESSION['cb1'];?>
 </div>
<div id="m2" style="position:absolute;color:#FFF;top:30px;left:200px"><?php echo $_SESSION['cb2'];
?></div>

<div id="a1"   style="position:absolute;color:#FFF;top:60px;left:15px"></div>
<div id="a2"   style="position:absolute;color:#FFF;top:60px;left:200px"></div>
<div id="writ" style="position:absolute;color:#FFF;top:120px;left:10px;width:200px;height:100px"></div>
</div>
[  Watch Out! When you slide it back first , it means you are Folding and the Auction is won by other player. ]
</div>

<div id="c3_b" style="display:block;position:absolute"></div>    <!--hids c3 auction-->
<div id="c1" style="display:block;top:35px;let:680px; color:#FFF">

<?php
echo $_SESSION['cb1'];echo "         ";echo $_SESSION['sp1'];
echo '<br><br>';
echo $_SESSION['cb2'];echo "         ";echo $_SESSION['sp2'];
?>
</div>
