...
<title>Web Street Entry Pass</title>
...
<form id="form" name="form" method="post"   action= <?php bn();?> >
<h1>PLAYER 1</h1>
...
<input type="text" name="name1" id="name" value="player1"/>

<label>_lucky Token</label>
<select id="p1t" name="tokenn1">
...
<input type="button"  class="button"  value="player2" onClick="save()">
</div>
...
<label>_cyber Name</label>
<input type="text" name="name2" id="name"  value="player2"/>

 <label>_lucky Token</label>
 <select id="p2t" name="tokenn2">
 <option value="1">dog</option>
 <option value="2">hat</option>
 <option value="3">car</option>
 <option value="4">plane</option>
...
<input type="submit" class="button"  value="run in web street!">
</div>
</form>
</div>
