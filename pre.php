...
<body background="runn!.jpg" bgcolor="#000000" width="1088" height="680" >
 ...
 //$Result=mysql_db_query('webstreet','SELECT pid,pname FROM players');
 ...
 {
 //echo "<tr>";
 //echo "<td>".$row["pid"]."</td>"."<td>".$row["pname"]."</td>";
...
<form id="form" name="form" method="post" action="welcome.php">
<h1>PLAYER 1</h1>
...
<input type="submit" id="bon" class="button" alt="submit"  onclick="save(this.form)" value="player 2">

<!--<input type="submit" id="bon" class"button">-->
</form>
</div>
...
<form id="form2" name="form2" method="post" action="entry.html">
<h1>PLAYER 2</h1>
...
<input type="button"  class="button" onclick="save(this.form)" value="run in web street">
